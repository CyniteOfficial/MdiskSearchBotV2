...
class Config(object):
    API_ID = int(os.getenv("API_ID", "16645323"))
    API_HASH = os.getenv("API_HASH", "60194311c36bf2a19ff56ff3f9b843e8")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "6462775914:AAFwR33Oi4AJ6H9WB7UWU3RFmvMcPl5pt-8")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "mdiskcynitebot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "String")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001877616767")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "all_movies_xbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5478057335"))
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001877616767")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://gzharsh7:harsh1111@cluster0.q2j7qjf.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001942726529"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "new_movies_collection_hd5")
