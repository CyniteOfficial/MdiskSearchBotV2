...
class Config(object):
    ...
    API_HASH = os.getenv("API_HASH", "35142c1407be6264e68fb6bec5dcabd9")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5943805159:AAFT5gv-T7zb0N9LSmoHaQ1tn0U7iHHAuHc")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "mdiskvjbot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001855754121")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Mdiskautofilterbot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5606411877"))
#    OWNER_USERNAME = os.getenv("OWNER_USERNAME", "Anjel_Neha")
    BACKUP_CHANNEL = os.getenv("BACKUP_CHANNEL", "VJ_Bots")
...
Jᴜsᴛ Tʏᴘᴇ ᴀ Mᴏᴠɪᴇ Nᴀᴍᴇ 🎬**""" ) 
    START_PHOTO = os.getenv("START_PHOTO", "https://te.legra.ph/file/cd8a9025743fbd00ea339.jpg")
    HOME_TEXT = os.getenv("HOME_TEXT", """ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕

ɪ ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ᴛʜᴇʀᴇ ʏᴏᴜʀ ʟɪɴᴋꜱ.

ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001787446188")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://vjmovierequest:vjmovierequest@cluster0.lthu1hh.mongodb.net/?retryWrites=true&w=majority")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001834678099"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "VJ_Bots")
    FORCE_SUB = os.getenv("FORCE_SUB", "True")
    AUTO_DELETE_TIME = int(os.getenv("AUTO_DELETE_TIME", 300))
    MDISK_API = os.getenv("MDISK_API", "t7Dgnd4HOeAXPZHSJoym")
...
ᴅᴍ ꜰᴏʀ ᴀɴʏ Qᴜᴇʀʏ @VJ_Bot_Disscussion 🤖""" )
    ABOUT_WATCH_TEXT = """
ʜᴇʏ ʙᴜᴅᴅʏ, 
