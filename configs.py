...
class Config(object):
    ...
    BOT_TOKEN = os.getenv("BOT_TOKEN", "Api Hash")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "mdiskbot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "Use string")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "Db Channel")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Bot Username")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "Owner Id"))
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "Update id")
    DATABASE_URL = os.getenv("DATABASE_URL", "Db Url")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "logs"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "Username")
